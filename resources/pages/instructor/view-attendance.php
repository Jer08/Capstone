...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <button class="add" onclick="exportTableToExcel('attendaceTable', '<?php echo $subjectCode ?>_on_<?php echo date('Y-m-d'); ?>','<?php echo $coursename ?>', '<?php echo $subjectname ?>')">Export Attendance As Excel</button>
