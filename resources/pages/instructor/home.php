...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <p style="font:80px; font-weight:400; color:blue; text-align:center; padding-top:2px;">Please select course, subject, and venue first. Before Launching Facial Recognition</p>
